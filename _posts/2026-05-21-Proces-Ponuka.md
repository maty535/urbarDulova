---
layout: post
title: "Proces ponuky pre odpredaj podielu na spoločnej nehnuteľnosti a jej uplatnenia v kontexte pozemkových spoločenstiev"
date: 2026-05-21
...
V kontexte pozemkových spoločenstiev (urbariátov) a predkupného práva má proces ponuky a jej uplatnenia presné pravidlá. Tento proces prebieha v dvoch rovinách: **ako ponuku robí predávajúci** a **ako na ňu reagujú ostatní podielnici**.
...
## Zhrnutie v skratke
1. Predávajúci doručí písomnú ponuku s cenou **výboru**.
2. Prebehne najbližšie **valné zhromaždenie**.
